...
class Game:
    ...
    # getting the images for the player, gun, enemies, etc
    def load_images(self):
        ...
        for folder in folders:
            for folder_path, _, file_names in walk(join('images', 'enemies', folder)):
                ...
                for file_name in sorted(file_names, key = lambda name: int(name.split('.')[0])): # basically looping through the folder and getting the file names in a sorted order for the animations
